...
class WorkerStep2RoleInfo extends StatefulWidget {
  final GlobalKey<FormState> formKey;
  final WorkerSignupData signupData;

  const WorkerStep2RoleInfo({super.key, required this.formKey, required this.signupData});

  @override
  State<WorkerStep2RoleInfo> createState() => _WorkerStep2RoleInfoState();
}

class _WorkerStep2RoleInfoState extends State<WorkerStep2RoleInfo> {
  ...
  void initState() {
    super.initState();
    if (widget.signupData.jobCategory != null) {
      _subcategories = _categories[widget.signupData.jobCategory!] ?? [];
    }
  }
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              value: widget.signupData.jobCategory,
              ...
              onChanged: (val) {
                setState(() {
                  widget.signupData.jobCategory = val;
                  widget.signupData.subCategory = null; // Reset subcategory
            ...
            if (_subcategories.isNotEmpty)
              DropdownButtonFormField<String>(
                value: widget.signupData.subCategory,
                ...
                onChanged: (val) => setState(() => widget.signupData.subCategory = val),
                validator: (val) => val == null ? 'Please select a subcategory' : null,
              ),
            const SizedBox(height: 20),
            DropdownButtonFormField<String>(
              value: widget.signupData.experienceLevel,
              ...
              items: ['Beginner', 'Intermediate', 'Professional']
                  ...
                  .toList(),
              onChanged: (val) => setState(() => widget.signupData.experienceLevel = val),
