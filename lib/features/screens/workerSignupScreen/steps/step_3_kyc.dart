...
class SignupStep3Kyc extends StatefulWidget {
  final GlobalKey<FormState> formKey;
  final SignupData data;

  const SignupStep3Kyc({super.key, required this.formKey, required this.data});

  @override
  State<SignupStep3Kyc> createState() => _SignupStep3KycState();
}

class _SignupStep3KycState extends State<SignupStep3Kyc> {
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            TextFormField(
              initialValue: widget.data.aadhaarNumber,
              ...
              onSaved: (val) => widget.data.aadhaarNumber = val,
            ),
            const SizedBox(height: 20),
            TextFormField(
              initialValue: widget.data.panNumber,
              ...
              onSaved: (val) => widget.data.panNumber = val?.toUpperCase(),
            ),
